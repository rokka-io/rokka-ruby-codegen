...
# Unit tests for RokkaClientCodegen::Organization
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'Organization' do
  before do
    # run before each test
    @instance = RokkaClientCodegen::Organization.new
  end
  ...
  describe 'test an instance of Organization' do
    it 'should create an instance of Organization' do
      expect(@instance).to be_instance_of(RokkaClientCodegen::Organization)
    end
  end
