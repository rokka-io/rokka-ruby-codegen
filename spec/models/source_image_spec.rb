...
# Unit tests for RokkaClientCodegen::SourceImage
# Automatically generated by swagger-codegen (github.com/swagger-api/swagger-codegen)
# Please update as you see appropriate
describe 'SourceImage' do
  before do
    # run before each test
    @instance = RokkaClientCodegen::SourceImage.new
  end
  ...
  describe 'test an instance of SourceImage' do
    it 'should create an instance of SourceImage' do
      expect(@instance).to be_instance_of(RokkaClientCodegen::SourceImage)
    end
  end
